...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <div className="pb-24 pt-2 px-4 max-w-md mx-auto space-y-4 font-sans text-black relative">
      ...
      {/* 🎯 Yellow Hero Header Card */}
      <div className="bg-[#FFE66D] doodle-border doodle-shadow p-6 text-center space-y-3">
      ...
      <div className="bg-white doodle-border doodle-shadow p-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full border-2 border-black transition-colors relative ${
              notifications ? 'bg-[#FFE66D]' : 'bg-gray-200'
            }`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`w-12 h-6 rounded-full border-2 border-black transition-colors relative ${
              soundEffects ? 'bg-[#FFE66D]' : 'bg-gray-200'
            }`}
          >
            <div className={`w-4 h-4 rounded-full bg-white border border-black transition-transform absolute top-0.5 ${
      ...
      <div className="space-y-2.5 pt-2">
        <button
          onClick={handleSave}
          className="w-full py-3 bg-[#FFE66D] text-black doodle-border doodle-shadow font-black text-sm doodle-btn flex items-center justify-center gap-2"
        >
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white doodle-border doodle-shadow w-full max-w-xs p-5 space-y-4 animate-in fade-in zoom-in-95 duration-150">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-[#FFE66D] doodle-border doodle-shadow font-extrabold text-xs doodle-btn flex items-center justify-center gap-2"
            >
