    ...
    <div className="pb-24 pt-3 px-4 max-w-md mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className={`h-10 px-3 doodle-border-sm doodle-shadow-sm flex items-center justify-center gap-1 text-xs font-black doodle-btn transition-colors ${
            calendarViewMode === 'month' ? 'bg-[#FFE66D]' : 'bg-white hover:bg-gray-50'
          }`}
            ...
            <button
              ...
              className={`flex flex-col items-center py-2.5 px-1 doodle-border-sm doodle-btn relative transition-all ${
                dragOverDate === day.dateStr
                  ...
                  : day.isSelected
                  ? 'bg-[#FFE66D] doodle-shadow scale-105 z-10 border-[3px]'
        ...
        <div className="bg-white doodle-border doodle-shadow p-3.5 space-y-2.5 animate-in fade-in zoom-in-95 duration-200">
          <div className="flex items-center justify-between pb-2 border-b-2 border-black">
            <button
              ...
              className="p-1.5 bg-gray-100 hover:bg-[#FFE66D] doodle-border-sm doodle-btn"
              title={t.prevMonth}
            >
                ...
                <button
                  ...
                  className={`min-h-[42px] p-1 rounded doodle-border-sm flex flex-col items-center justify-between transition-all relative ${
                    isHovered
                      ? 'bg-emerald-100 border-dashed border-emerald-600 scale-105 z-20'
                      : isSelected
                      ? 'bg-[#FFE66D] doodle-shadow-sm font-black border-[2.5px] scale-105 z-10'
                      : cell.isToday
      ...
      {missedTasks.length > 0 && (
        <div className="bg-[#FFE5E5] doodle-border doodle-shadow p-4 relative overflow-hidden transition-all">
          ...
          >
            <Sparkles className="w-4 h-4 text-[#FFE66D] animate-pulse" />
          ...
          <div className="bg-[#FCF9F8] doodle-border doodle-shadow-lg max-w-md w-full p-5 space-y-4 max-h-[85vh] overflow-y-auto">
              ...
              {proposals.map((p, idx) => (
                <div key={idx} className="bg-white doodle-border-sm p-3.5 doodle-shadow-sm space-y-1.5">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="bg-[#FFE66D] text-[10px] font-black px-2 py-0.5 rounded-full border border-black">
                      {p.newTime}
                    </span>
                  </div>
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-[#1A1A1A] text-[#FFE66D] doodle-border border-[#1A1A1A] font-extrabold text-xs doodle-btn flex items-center justify-center gap-1.5"
              >
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1 bg-[#FFE66D] px-3 py-1.5 doodle-border-sm doodle-shadow-sm text-xs font-black doodle-btn"
            >
        ...
        {activeTasks.length === 0 ? (
          <div className="bg-white doodle-border doodle-shadow p-6 text-center space-y-2">
            ...
            >
              <Plus className="w-3.5 h-3.5 text-[#FFE66D]" /> {t.addTask}
            </button>
          </div>
        ) : viewMode === 'list' ? (
            ...
            {activeTasks.map((task) => (
              ...
              >
                {task.isAiRescheduled && (
                  <div className="absolute -top-3.5 right-4 bg-[#FFE66D] px-3 py-0.5 doodle-border-sm border-b-0 rounded-t-lg font-black text-[10px] flex items-center gap-1 shadow-[2px_0px_0px_#1A1A1A]">
                        ...
                        {!task.completed && (
                          <div className="flex items-center gap-1 ml-1">
                            <button
                              ...
                              className="px-1.5 py-0.5 text-[10px] font-black bg-gray-100 hover:bg-[#FFE66D] doodle-border-sm rounded transition-colors"
                          ...
                          return (
                            <div
                              ...
                              className={`doodle-border-sm p-2 rounded-lg font-bold text-black flex items-center justify-between absolute left-3 right-0 z-10 transition-all ${
                                task.completed ? 'bg-gray-100 line-through opacity-70' : 'bg-[#FFE66D]'
                              }`}
                            >
          ...
          <div className="bg-white doodle-border doodle-shadow-lg max-w-md w-full p-5 space-y-4">
            ...
            <form onSubmit={handleCreateTask} className="space-y-3 text-xs font-bold">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 bg-[#FFE66D] doodle-border-sm font-black doodle-btn"
                >
                  {t.save}
                </button>
              </div>
