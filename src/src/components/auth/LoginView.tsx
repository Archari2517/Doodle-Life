...
export const LoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FCF9F8] text-[#1A1A1A] flex flex-col items-center justify-center p-6 font-['Manrope'] selection:bg-[#FFE66D]">
      <div className="w-full max-w-sm bg-white border-4 border-[#1A1A1A] rounded-2xl p-8 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] space-y-6 text-center">
        ...
        <div className="space-y-2">
          <div className="w-16 h-16 bg-[#FFE66D] border-4 border-[#1A1A1A] rounded-2xl mx-auto flex items-center justify-center text-3xl shadow-[4px_4px_0px_0px_rgba(26,26,26,1)]">
            ✍️
          </div>
