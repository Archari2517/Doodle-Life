  ...
  return (
    <div className="pb-28 pt-2 px-4 max-w-md mx-auto space-y-6">
      ...
      <div className="relative mt-5">
        <div className="absolute -top-4 left-4 bg-[#FFE66D] px-4 py-1 doodle-border-sm border-b-0 rounded-t-lg rounded-b-none font-extrabold text-xs z-10 doodle-shadow-sm">
          {t.newGoal}
        </div>
        ...
        <div className="bg-white doodle-border doodle-shadow p-5 pt-7 relative z-0 space-y-5">
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <button
                  ...
                  className={`p-3.5 doodle-border-sm flex flex-col items-center justify-center gap-1 font-extrabold text-xs h-20 transition-all doodle-btn ${
                    goalType === 'short_term'
                      ? 'bg-[#FFE66D] doodle-shadow-sm border-[3px]'
            ...
            <button
              type="submit"
              className="w-full bg-[#1A1A1A] text-[#FFE66D] doodle-border border-[#1A1A1A] py-3.5 rounded-xl font-black text-base flex items-center justify-center gap-2 doodle-btn shadow-[3px_3px_0px_#000]"
            >
          ...
          <div key={goal.id} className="bg-white doodle-border doodle-shadow-sm p-4 space-y-3 relative">
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-full bg-[#FFE66D] doodle-border-sm flex items-center justify-center text-lg shrink-0">
                  {goal.categoryIcon || '🎯'}
                </div>
                <div>
